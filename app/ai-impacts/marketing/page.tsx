...
import { ArrowRight, TrendingUp, FileText, BarChart, CheckCircle, Check } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#a8b4d4] via-[#8b9dc3] to-[#7c8bc4] pt-24 font-sans text-slate-900">
      <div className="relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 relative z-10 flex items-center gap-2 text-sm text-slate-800">
          ...
          <span className="text-slate-500">/</span>
          <span className="text-blue-700 font-semibold">Marketing - Branchen-Analyse</span>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center gap-8 mb-12">
            <div className="p-6 bg-blue-500/20 rounded-2xl border border-blue-400/30 backdrop-blur-sm">
              <GlassIcon icon={BarChart} color="blue" size="xl" />
            </div>
            <div>
              <h1 className="text-5xl font-bold mb-4 text-slate-900">Marketing - Branchen-Analyse</h1>
              <p className="text-xl text-slate-700 max-w-2xl">
                Automatische Analyse von Branchentrends, Wettbewerbern und Marktchancen.
                KI-gestützte Insights für datengetriebenes Marketing.
              </p>
            </div>
          </div>
            ...
            {[
              {
                ...
                description: "Automatische Sammlung von Daten aus verschiedenen Quellen.",
                features: ["Web Scraping", "API Integration", "Social Media Monitoring", "News Aggregation"],
                color: "blue"
              },
              {
                step: "2",
                title: "KI-Analyse",
                description: "KI-gestützte Analyse von Trends, Sentiment und Wettbewerbsdaten.",
                features: ["Trend Analysis", "Sentiment Analysis", "Competitor Analysis", "Market Insights"],
                color: "purple"
              },
              {
                step: "3",
                title: "Report-Generierung",
                description: "Automatische Generierung von umfassenden Analyse-Reports.",
                features: ["Executive Summary", "Visualizations", "Key Findings", "Recommendations"],
                color: "green"
              },
              {
                step: "4",
                title: "Distribution",
                description: "Automatische Verteilung von Reports an relevante Stakeholder.",
                features: ["Email Distribution", "Dashboard Updates", "Slack Notifications", "Scheduled Reports"],
                color: "orange"
              }
            ].map((item, i) => (
      ...
      <section className="py-20 px-6 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { icon: BarChart, title: "Datengetriebene Entscheidungen", desc: "Bessere Marketing-Strategien basierend auf echten Daten", color: "blue" },
              { icon: TrendingUp, title: "Wettbewerbsvorteil", desc: "Frühe Erkennung von Trends und Chancen", color: "green" },
              { icon: CheckCircle, title: "Zeitersparnis", desc: "Automatische Analyse spart Wochen an manueller Arbeit", color: "orange" }
            ].map((benefit, i) => (
      ...
      <section className="py-20 px-6 relative">
        <div className="max-w-4xl mx-auto text-center">
          <Card className="p-12 glass-card-neon bg-gradient-to-br from-blue-600/90 to-indigo-700/90 border-white/20 text-white shadow-2xl">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Bereit, Branchen-Analyse zu automatisieren?</h2>
            <p className="text-xl mb-8 text-blue-100 max-w-2xl mx-auto">Starten Sie noch heute mit QORTEX und gewinnen Sie wertvolle Insights.</p>
