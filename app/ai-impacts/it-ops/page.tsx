...
import { ArrowRight, Users, Zap, CheckCircle, Settings, Check } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#a8b4d4] via-[#8b9dc3] to-[#7c8bc4] pt-24 font-sans text-slate-900">
      <div className="relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 relative z-10 flex items-center gap-2 text-sm text-slate-800">
          ...
          <span className="text-slate-500">/</span>
          <span className="text-blue-700 font-semibold">IT Ops - Mitarbeiter onboarden</span>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center gap-8 mb-12">
            <div className="p-6 bg-orange-500/20 rounded-2xl border border-orange-400/30 backdrop-blur-sm">
              <GlassIcon icon={Users} color="orange" size="xl" />
            </div>
            <div>
              <h1 className="text-5xl font-bold mb-4 text-slate-900">Mitarbeiter Onboarding Automatisierung</h1>
              <p className="text-xl text-slate-700 max-w-2xl">
                Reduzieren Sie die Onboarding-Zeit von Tagen auf Minuten. Automatisierte Account-Erstellung,
                Zugriffsrechte und Hardware-Bestellung.
              </p>
            </div>
          </div>
             ...
             {[
              {
                ...
                description: "Automatische Erstellung von Benutzerkonten in allen relevanten Systemen.",
                features: ["Active Directory", "Email Account", "SSO Setup", "Password Generation"],
                color: "blue"
              },
              {
                step: "2",
                title: "Zugriffsrechte",
                description: "Automatische Zuweisung von Berechtigungen basierend auf Rolle und Abteilung.",
                features: ["Role-Based Access", "Application Access", "Folder Permissions", "VPN Setup"],
                color: "purple"
              },
              {
                step: "3",
                title: "Hardware-Bereitstellung",
                description: "Automatisierte Bestellung und Konfiguration von Hardware.",
                features: ["Device Ordering", "Software Installation", "Configuration", "Shipping"],
                color: "orange"
              },
              {
                step: "4",
                title: "Dokumentation & Training",
                description: "Automatische Bereitstellung von Onboarding-Materialien und Zugang zu Trainings.",
                features: ["Welcome Package", "Training Access", "Documentation", "Buddy Assignment"],
                color: "green"
              }
            ].map((item, i) => (
      ...
      <section className="py-20 px-6 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { icon: Zap, title: "Zeitersparnis", desc: "Reduzierung der Onboarding-Zeit von 2 Tagen auf 2 Stunden", color: "orange" },
              { icon: CheckCircle, title: "Konsistenz", desc: "Standardisierter Prozess für alle neuen Mitarbeiter", color: "green" },
              { icon: Settings, title: "Fehlerreduktion", desc: "Keine manuellen Fehler bei Account-Erstellung", color: "blue" }
            ].map((benefit, i) => (
      ...
      <section className="py-20 px-6 relative">
        <div className="max-w-4xl mx-auto text-center">
          <Card className="p-12 glass-card-neon bg-gradient-to-br from-orange-600/90 to-amber-600/90 border-white/20 text-white shadow-2xl">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Bereit, Mitarbeiter-Onboarding zu automatisieren?</h2>
            <p className="text-xl mb-8 text-orange-100 max-w-2xl mx-auto">Starten Sie noch heute mit QORTEX und erleben Sie die Effizienz.</p>
