...
export function QortexFooter() {
  return (
    <footer className="relative pt-0 pb-12 overflow-hidden bg-black">
      {/* 
        The "Electric Wave" Separator 
        Integrated into the footer - creates seamless transition
      */}
      <div className="absolute top-0 left-0 w-full h-[200px] transform -translate-y-[95%] z-30">
        <svg
      ...
      {/* Footer Content */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-40 pt-32">
